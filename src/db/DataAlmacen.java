...
public class DataAlmacen {
    public static Vector<Vector<Object>> cargarAlmacen() {
        ...
        med2.add(180);
        med2.add(3.20);
        med2.add("FarmaPlus Distribuciones");
        data.add(med2);
        ...
        med6.add(150);
        med6.add(5.10);
        med6.add("Laboratorios VitaCorp");
        data.add(med6);
        ...
        med10.add(60);
        med10.add(8.60);
        med10.add("Distribuciones MediPharm");
        data.add(med10);
        ...
        med11.add(140);
        med11.add(4.10);
        med11.add("Laboratorios Vitalis");
        data.add(med11);
        ...
        med12.add(220);
        med12.add(3.15);
        med12.add("Distribuciones FarmaSur");
        data.add(med12);
        ...
        med13.add(110);
        med13.add(5.60);
        med13.add("Laboratorios Medifarma");
        data.add(med13);
        ...
        med14.add(95);
        med14.add(6.80);
        med14.add("Laboratorios Sanitas");
        data.add(med14);
        ...
        med15.add(160);
        med15.add(3.75);
        med15.add("Distribuciones MediPharm");
        data.add(med15);
        ...
        med18.add(130);
        med18.add(3.90);
        med18.add("Farmacéutica Ibérica");
        data.add(med18);
        ...
        med19.add(70);
        med19.add(8.30);
        med19.add("Laboratorios Argenix");
        data.add(med19);
        ...
        med20.add(145);
        med20.add(6.10);
        med20.add("Laboratorios VitaCorp");
        data.add(med20);
        ...
        med21.add(125);
        med21.add(4.50);
        med21.add("Distribuciones Quimicor");
        data.add(med21);
        ...
        med24.add(85);
        med24.add(7.90);
        med24.add("Laboratorios Sanitas");
        data.add(med24);
        ...
        med25.add(60);
        med25.add(4.75);
        med25.add("FarmaPlus Distribuciones");
        data.add(med25);
        ...
        med26.add(90);
        med26.add(8.20);
        med26.add("Laboratorios Vitalis");
        data.add(med26);
        ...
        med28.add(110);
        med28.add(4.60);
        med28.add("Laboratorios Argenix");
        data.add(med28);
        ...
        med31.add(320);
        med31.add(2.10);
        med31.add("Laboratorios Sanitas");
        data.add(med31);
        ...
        med32.add(95);
        med32.add(5.75);
        med32.add("Laboratorios VitaCorp");
        data.add(med32);
        ...
        med33.add(65);
        med33.add(6.20);
        med33.add("Distribuciones FarmaSur");
        data.add(med33);
        ...
        med35.add(210);
        med35.add(3.80);
        med35.add("Laboratorios Argenix");
        data.add(med35);
        ...
        med36.add(170);
        med36.add(4.00);
        med36.add("Distribuciones MediPharm");
        data.add(med36);
        ...
        med37.add(160);
        med37.add(3.95);
        med37.add("Laboratorios Vitalis");
        data.add(med37);
        ...
        med41.add(95);
        med41.add(5.25);
        med41.add("Laboratorios Sanitas");
        data.add(med41);
        ...
        med42.add(55);
        med42.add(11.90);
        med42.add("Farmacéutica Ibérica");
        data.add(med42);
        ...
        med43.add(85);
        med43.add(6.90);
        med43.add("Laboratorios Argenix");
        data.add(med43);
        ...
        med45.add(210);
        med45.add(2.70);
        med45.add("Laboratorios Vitalis");
        data.add(med45);
        ...
        med46.add(75);
        med46.add(21.50);
        med46.add("Distribuciones Quimicor");
        data.add(med46);
        ...
        med47.add(30);
        med47.add(18.20);
        med47.add("Laboratorios Medifarma");
        data.add(med47);
        ...
        med49.add(95);
        med49.add(5.00);
        med49.add("FarmaPlus Distribuciones");
        data.add(med49);
